                ...
                <CCard className="mb-4">
                    ...
                    <CCardBody>
                        <p className="text-body-secondary small">
                            Wrap a pair of <code>&lt;CFormInput&gt;</code> and <code>&lt;CFormLabel&gt;</code> elements
                            in <code>CFormFloating</code> to enable floating labels with textual form fields. A{' '}
                            <code>placeholder</code> is required on each <code>&lt;CFormInput&gt;</code> as our method
                            of CSS-only floating labels uses the <code>:placeholder-shown</code> pseudo-element. Also
                            note that the <code>&lt;CFormInput&gt;</code> must come first so we can utilize a sibling
                        ...
                        <p className="text-body-secondary small">
                            When there&#39;s a <code>value</code> already defined, <code>&lt;CFormLabel&gt;</code>s will
                ...
                <CCard className="mb-4">
                    ...
                    <CCardBody>
                        ...
                        <p className="text-body-secondary small">
                            ...
                            <code>rows</code> attribute. Instead, set an explicit <code>height</code> (either inline or
                            via custom CSS).
                        </p>
                        <DocsExample href="forms/floating-labels#textareas">
                            <CFormFloating>
