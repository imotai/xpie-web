        ...
        <CRow>
            ...
            <CCol xs={12}>
                <CCard className="mb-4">
                    ...
                    <CCardBody>
                        <p className="text-body-secondary small">
                            By adding <a href="https://coreui.io/docs/layout/gutters/">gutter modifier classes</a>, you
                            can have control over the gutter width in as well the inline as block direction.
                        </p>
            ...
            <CCol xs={12}>
                <CCard className="mb-4">
                    ...
                    <CCardBody>
                        <p className="text-body-secondary small">
                            Create horizontal forms with the grid by adding the <code>.row</code> class to form groups
                            and using the <code>.col-*-*</code> classes to specify the width of your labels and
                            controls. Be sure to add <code>.col-form-label</code> to your{' '}
                        ...
                        <p className="text-body-secondary small">
                            ...
                            you need. For example, we&#39;ve removed the <code>padding-top</code> on our stacked radio
                            inputs label to better align the text baseline.
                        </p>
                ...
                <CCard className="mb-4">
                    ...
                    <CCardBody>
                        <p className="text-body-secondary small">
                            ...
                            <code>&lt;CFormLabel&gt;</code>s or <code>&lt;legend&gt;</code>s to correctly follow the
                            size of <code>.form-control-lg</code> and <code>.form-control-sm</code>.
                        </p>
                ...
                <CCard className="mb-4">
                    ...
                    <CCardBody>
                        <p className="text-body-secondary small">
                            ...
                            available width equally between them. You may also pick a subset of your columns to take up
                            more or less space, while the remaining <code>&lt;CCol&gt;</code>s equally split the rest,
                            with specific column classes like <code>&lt;CCol sm=&#34;7&#34;&gt;</code>.
                        </p>
                ...
                <CCard className="mb-4">
                    ...
                    <CCardBody>
                        <p className="text-body-secondary small">
                            ...
                            columns only take up as much space as needed. Put another way, the column sizes itself based
                            on the contents.
                        </p>
                ...
                <CCard className="mb-4">
                    ...
                    <CCardBody>
                        <p className="text-body-secondary small">
                            ...
                            adding <a href="https://coreui.io/docs/layout/gutters/">gutter modifier classes</a>, we will
                            have gutters in horizontal and vertical directions. The <code>.align-items-center</code>{' '}
                            aligns the form elements to the middle, making the <code>&lt;CFormCheck&gt;</code> align
                            properly.
                        </p>
