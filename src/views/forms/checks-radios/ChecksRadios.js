        ...
        <CRow>
            ...
            <CCol xs={12}>
                <CCard className="mb-4">
                    ...
                    <CCardBody>
                        <p className="text-body-secondary small">
                            Group checkboxes or radios on the same horizontal row by adding <code>inline</code> boolean
                            property to any <code>&lt;CFormCheck&gt;</code>.
                        </p>
                ...
                <CCard className="mb-4">
                    ...
                    <CCardBody>
                        <p className="text-body-secondary small">
                            ...
                            property on the <code>&lt;CFormCheck&gt;</code> component. These toggle buttons can further
                            be grouped in a button group if needed.
                        </p>
