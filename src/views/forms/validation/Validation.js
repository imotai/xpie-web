        ...
        <CRow>
                ...
                <CCard className="mb-4">
                    ...
                    <CCardBody>
                        <p className="text-body-secondary small">
                            ...
                            <code>noValidate</code> boolean property to your <code>&lt;CForm&gt;</code>. This disables
                            ...
                            and relay feedback to you. When attempting to submit, you&#39;ll see the{' '}
                ...
                <CCard className="mb-4">
                    ...
                    <CCardBody>
                        <p className="text-body-secondary small">
                            ...
                            you can indicate invalid and valid form fields with <code>invalid</code> and{' '}
                        ...
                        <p className="text-body-secondary small">
                            ...
                            relevant form field using <code>aria-describedby</code> (noting that this attribute allows
                            more than one <code>id</code> to be referenced, in case the field already points to
            ...
            <CCol xs={12}>
                <CCard className="mb-4">
                    ...
                    <CCardBody>
                        <p className="text-body-secondary small">
                            If your form layout allows it, you can swap the text for the tooltip to display validation
                            feedback in a styled tooltip. Be sure to have a parent with <code>position: relative</code>{' '}
                            on it for tooltip positioning. In the example below, our column classes have this already,
