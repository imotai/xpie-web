        ...
        <CRow>
            <CCol xs={12}>
                <CCard className="mb-4">
                    ...
                    <CCardBody>
                        ...
                        <p className="text-body-secondary small">
                            The border spinner uses <code>currentColor</code> for its <code>border-color</code>. You can
                ...
                <CCard className="mb-4">
                    ...
                    <CCardBody>
                        ...
                        <p className="text-body-secondary small">
                            ...
                            its appearance. Here it is in blue, along with the supported variants.
                        </p>
                        <DocsExample href="components/spinner#growing-spinner">
            ...
            <CCol xs={12}>
                <CCard className="mb-4">
                    ...
                    <CCardBody>
                        <p className="text-body-secondary small">
                            Add <code>size=&#34;sm&#34;</code> property to make a smaller spinner that can quickly be
