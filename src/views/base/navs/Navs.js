        ...
        <CRow>
                ...
                <CCard className="mb-4">
                    ...
                    <CCardBody>
                        <p className="text-body-secondary small">
                            The base <code>.nav</code> component is built with flexbox and provide a strong foundation
                            for building all types of navigation components. It includes some style overrides (for
                        ...
                        <p className="text-body-secondary small">
                            ...
                            important, or roll your own with a <code>&lt;nav&gt;</code> element. Because the .nav uses
                            display: flex, the nav links behave the same as nav items would, but without the extra
                            markup.
                        </p>
                        <DocsExample href="components/nav#base-nav">
                            <CNav component="nav">
                ...
                <CCard className="mb-4">
                    ...
                    <CCardBody>
                        <p className="text-body-secondary small">
                            ...
                            <a href="https://coreui.io/docs/layout/grid/#horizontal-alignment">flexbox utilities</a>. By
            ...
            <CCol xs={12}>
                <CCard className="mb-4">
                    ...
                    <CCardBody>
                        <p className="text-body-secondary small">
                            Stack your navigation by changing the flex item direction with the <code>.flex-column</code>{' '}
                            utility. Need to stack them on some viewports but not others? Use the responsive versions
                ...
                <CCard className="mb-4">
                    ...
                    <CCardBody>
                        ...
                        <p className="text-body-secondary small">
                            ...
                            will be occupied by nav links, but unlike the .nav-fill above, every nav item will be the
                            same width.
                        </p>
                        <DocsExample href="components/nav#fill-and-justify">
                ...
                <CCard className="mb-4">
                    ...
                    <CCardBody>
                        <p className="text-body-secondary small">
                            ...
                            <a href="https://coreui.io/docs/utilities/flex">flexbox utilities</a>. While more verbose,
                            these utilities offer greater customization across responsive breakpoints. In the example
                            below, our nav will be stacked on the lowest breakpoint, then adapt to a horizontal layout
