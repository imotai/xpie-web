        ...
        <CRow>
                ...
                <CCard className="mb-4">
                    ...
                    <CCardBody>
                        <p className="text-body-secondary small">
                            ...
                            bunch of control and customization. Built with flexbox, they offer easy alignment and mix
                            well with other CoreUI components. Cards have no top, left, and right margins by default, so
                            use <a href="https://coreui.io/docs/utilities/spacing">spacing utilities</a> as needed. They
                            have no fixed width to start, so they&#39;ll fill the full width of its parent.
                        </p>
                        <p className="text-body-secondary small">
            ...
            <CCol xs={12}>
                <CCard className="mb-4">
                    ...
                    <CCardBody>
                        <p className="text-body-secondary small">
                            The main block of a card is the <code>&lt;CCardBody&gt;</code>. Use it whenever you need a
            ...
            <CCol xs={12}>
                <CCard className="mb-4">
                    ...
                    <CCardBody>
                        <p className="text-body-secondary small">
                            Card titles are managed by <code>&lt;CCardTitle&gt;</code> component. Identically, links are
                            attached and collected next to each other by <code>&lt;CCardLink&gt;</code> component.
                        </p>
                        <p className="text-body-secondary small">
                            ...
                            stored in a <code>&lt;CCardBody&gt;</code> item, the card title, and subtitle are arranged
                            rightly.
                        </p>
                ...
                <CCard className="mb-4">
                    ...
                    <CCardBody>
                        <p className="text-body-secondary small">
                            ...
                            <code>.card-text</code>, text can be added to the card. Text within <code>.card-text</code>{' '}
                ...
                <CCard className="mb-4">
                    ...
                    <CCardBody>
                        <p className="text-body-secondary small">
                            ...
                            there. Shown below are image styles, blocks, text styles, and a list group—all wrapped in a
                            fixed-width card.
                        </p>
            ...
            <CCol xs={12}>
                <CCard className="mb-4">
                    ...
                    <CCardBody>
                        <p className="text-body-secondary small">Add an optional header and/or footer within a card.</p>
                ...
                <CCard className="mb-4">
                    ...
                    <CCardBody>
                        <p className="text-body-secondary small">
                            ...
                            otherwise stated. You can adjust this as required with custom CSS, grid classes, grid Sass
                            mixins, or services.
                        </p>
                        ...
                        <p className="text-body-secondary small">
                            Use some of{' '}
                            <a href="https://coreui.io/docs/utilities/sizing/">available sizing utilities</a> to rapidly
                            set a card&#39;s width.
                        </p>
                        <DocsExample href="components/card/#sizing">
            ...
            <CCol xs={12}>
                <CCard className="mb-4">
                    ...
                    <CCardBody>
                        <p className="text-body-secondary small">
                            Add some navigation to a <code>&lt;CCardHeader&gt;</code> with our <code>&lt;CNav&gt;</code>{' '}
                            component.
                        </p>
            ...
            <CCol xs={12}>
                <CCard className="mb-4">
                    ...
                    <CCardBody>
                        ...
                        <h3>Border</h3>
                        <p className="text-body-secondary small">
                            Use <a href="https://coreui.io/docs/utilities/borders/">border utilities</a> to change just
                            the <code>border-color</code> of a card. Note that you can set <code>textColor</code>{' '}
                            property on the <code>&lt;CCard&gt;</code> or a subset of the card&#39;s contents as shown
                            below.
                        </p>
                ...
                <CCard className="mb-4">
                    ...
                    <CCardBody>
                        <p className="text-body-secondary small">
                            ...
                            columns. Card groups start off stacked and use <code>display: flex;</code> to become
                            attached with uniform dimensions starting at the <code>sm</code> breakpoint.
                        </p>
                ...
                <CCard className="mb-4">
                    ...
                    <CCardBody>
                        <p className="text-body-secondary small">
                            ...
                            here&#39;s <code>xs=&#123;&#123;cols: 1&#125;&#125;</code> laying out the cards on one
                            column, and <code>md=&#123;&#123;cols: 1&#125;&#125;</code> splitting four cards to equal
                        ...
                        <p className="text-body-secondary small">
                            Change it to <code>md=&#123;&#123; cols: 3&#125;&#125;</code> and you&#39;ll see the fourth
                            card wrap.
                        </p>
                        <DocsExample href="components/card/#grid-cards">
