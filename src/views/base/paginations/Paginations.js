                ...
                <CCard className="mb-4">
                    ...
                    <CCardBody>
                        <p className="text-body-secondary small">
                            ...
                            <code>&lt;nav&gt;</code> element to identify it as a navigation section to screen readers
                            and other assistive technologies.
                        </p>
                        <p className="text-body-secondary small">
                            In addition, as pages likely have more than one such navigation section, it&#39;s advisable
                            to provide a descriptive <code>aria-label</code> for the <code>&lt;nav&gt;</code> to reflect
            ...
            <CCol xs={12}>
                <CCard className="mb-4">
                    ...
                    <CCardBody>
                        ...
                        <p className="text-body-secondary small">
                            While the <code>disabled</code> prop uses <code>pointer-events: none</code> to <em>try</em>{' '}
                            to disable the link functionality of <code>&lt;a&gt;</code>s, that CSS property is not yet
                            standardized and doesn&#39;taccount for keyboard navigation. As such, we always add{' '}
                            <code>tabindex=&#34;-1&#34;</code> on disabled links and use custom JavaScript to fully
