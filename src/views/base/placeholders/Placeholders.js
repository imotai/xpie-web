        ...
        <CRow>
            <CCol xs={12}>
                <CCard className="mb-4">
                    ...
                    <CCardBody>
                        <p className="text-body-secondary small">
                            ...
                            applied to create a &#34;loading card&#34;. Size and proportions are the same between the
                            two.
                        </p>
                ...
                <CCard className="mb-4">
                    ...
                    <CCardBody>
                        <p className="text-body-secondary small">
                            Create placeholders with the <code>&lt;CPlaceholder&gt;</code> component and a grid column
                            propx (e.g., <code>xs={6}</code>) to set the <code>width</code>. They can replace the text
                ...
                <CCard className="mb-4">
                    ...
                    <CCardBody>
                        <p className="text-body-secondary small">
                            By default, the <code>&lt;CPlaceholder&gt;</code> uses <code>currentColor</code>. This can
                            be overridden with a custom color or utility class.
                        </p>
                ...
                <CCard className="mb-4">
                    ...
                    <CCardBody>
                        <p className="text-body-secondary small">
                            ...
                            parent element. Customize them with <code>size</code> prop: <code>lg</code>, <code>sm</code>
                            , or <code>xs</code>.
                        </p>
