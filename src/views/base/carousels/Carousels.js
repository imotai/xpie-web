        ...
        <CRow>
            ...
            <CCol xs={12}>
                <CCard className="mb-4">
                    ...
                    <CCardBody>
                        <p className="text-body-secondary small">
                            You can add captions to slides with the <code>&lt;CCarouselCaption&gt;</code> element within
                            any <code>&lt;CCarouselItem&gt;</code>. They can be immediately hidden on smaller viewports,
                            as shown below, with optional{' '}
                            <a href="https://coreui.io//utilities/display">display utilities</a>. We hide them with{' '}
                            <code>.d-none</code> and draw them back on medium-sized devices with{' '}
            ...
            <CCol xs={12}>
                <CCard className="mb-4">
                    ...
                    <CCardBody>
                        <p className="text-body-secondary small">
                            Add <code>transition=&#34;crossfade&#34;</code> to your carousel to animate slides with a
                ...
                <CCard className="mb-4">
                    ...
                    <CCardBody>
                        <p className="text-body-secondary small">
                            ...
                            indicators, and captions. Controls have been inverted from their default white fill with the{' '}
                            <code>filter</code> CSS property. Captions and controls have additional Sass variables that
