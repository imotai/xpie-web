        ...
        <CRow>
            ...
            <CCol xs={12}>
                <CCard className="mb-4">
                    ...
                    <CCardBody>
                        ...
                        <p className="text-body-secondary small">These classes can also be added to table variants:</p>
                        <DocsExample href="components/table#striped-rows">
            ...
            <CCol xs={12}>
                <CCard className="mb-4">
                    ...
                    <CCardBody>
                        ...
                        <p className="text-body-secondary small">
                            <a href="https://coreui.io/docs/utilities/borders#border-color">Border color utilities</a>{' '}
            ...
            <CCol xs={12}>
                <CCard className="mb-4">
                    ...
                    <CCardBody>
                        <p className="text-body-secondary small">
                            Table cells of <code>&lt;CTableHead&gt;</code> are always vertical aligned to the bottom.
                            Table cells in <code>&lt;CTableBody&gt;</code> inherit their alignment from{' '}
                                ...
                                <CTableBody>
                                    <CTableRow>
                                        ...
                                        <CTableDataCell>
                                            ...
                                            vertical space, to demonsCTableRowate how the vertical alignment works in
                                            the preceding cells.
                                        </CTableDataCell>
                                    </CTableRow>
            ...
            <CCol xs={12}>
                <CCard className="mb-4">
                    ...
                    <CCardBody>
                        <p className="text-body-secondary small">
                            Similar to tables and dark tables, use the modifier prop <code>color=&#34;light&#34;</code>{' '}
                            or <code>color=&#34;dark&#34;</code> to make <code>&lt;CTableHead&gt;</code>s appear light
                            or dark gray.
                        </p>
            ...
            <CCol xs={12}>
                <CCard className="mb-4">
                    ...
                    <CCardBody>
                        <p className="text-body-secondary small">
                            A <code>&lt;CTableCaption&gt;</code> functions like a heading for a table. It helps users
