        ...
        <CRow>
                ...
                <CCard className="mb-4">
                    ...
                    <CCardBody>
                        <p className="text-body-secondary small">
                            Below is a static modal example (meaning its <code>position</code> and <code>display</code>{' '}
                            have been overridden). Included are the modal header, modal body (required for{' '}
                            <code>padding</code>), and modal footer (optional). We ask that you include modal headers
            ...
            <CCol xs={12}>
                <CCard className="mb-4">
                    ...
                    <CCardBody>
                        <p className="text-body-secondary small">
                            If you don’t provide an <code>onDimsiss</code> handler to the Modal component, your modal
                            will behave as though the backdrop is static, meaning it will not close when clicking
                ...
                <CCard className="mb-4">
                    ...
                    <CCardBody>
                        <p className="text-body-secondary small">
                            ...
                            <code>&lt;CModal&gt;</code>. These sizes kick in at certain breakpoints to avoid horizontal
                ...
                <CCard className="mb-4">
                    ...
                    <CCardBody>
                        <p className="text-body-secondary small">
                            ...
                            via property <code>fullscrean</code>.
                        </p>
                        <table className="table">
                            <thead>
                                <tr>
